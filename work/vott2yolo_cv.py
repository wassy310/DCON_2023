...
from utils.annot_datasets import Bndbox
from utils.annot_datasets import Size
from utils.file_tools import VocXmlAnalyzer
from utils.file_tools import PbtxtAnalyzer
from utils.file_tools import YamlHandler
from utils.file_tools import TxtHandler
from utils.path_tools import GetFileListBySuffix
from utils.path_tools import OutputFilePathGenerator
...
def main():
    ...
    try:
        ...
        logger.info(f" '{out_dir}' was set as output directory.")
